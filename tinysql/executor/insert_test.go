...
func (s *testSuite3) TestOrderItemFunc(c *C) {
	...
	tk.MustExec("insert into t1(a, b) values('1236', '深入理解计算机系统')")
	tk.MustExec("insert into t1(a, b) values('123', '离散数学')")
	tk.MustExec("insert into t1(a, b) values('12345', 'Rust编程')")
	tk.MustExec("insert into t1(a, b) values('12345', '线性代数')")
	tk.MustExec("insert into t1(a, b) values('12345', '计算方法与实习')")
	tk.MustExec("insert into t1(a, b) values('12345', '软件工程')")
	tk.MustExec("insert into t1(a, b) values('12345', '概率论与数理统计')")
	fmt.Println("res: ", tk.MustQuery("select b from t1 order by TFIDFCMP(b, '软件工程') desc"))
}
